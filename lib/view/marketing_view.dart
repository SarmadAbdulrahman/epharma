    ...
    */
    ...
    //  drawer: MainDrawer(),
      body:Container(
        ...
        child: Column(
          children: <Widget>[
            accountItems("Plan 1", r"+ $ 100.00", "28-04-16", "credit",
                oddColour: const Color(0xFFF7F7F9)),
            accountItems(
                "aitems", r"+ $ 5,428.00", "26-04-16", "credit"),
            accountItems(" EU", r"+ $ 746.00", "25-04-216", "Payment",
                oddColour: const Color(0xFFF7F7F9)),
            accountItems(
                " Studios", r"+ $ 14,526.00", "16-04-16", "Payment"),
            accountItems(
                "Book", r"+ $ 2,876.00", "04-04-16", "Credit",
                oddColour: const Color(0xFFF7F7F9)),
          ],
        ),
      ),
